...
@section('content')
    ...
    <section class="company-section container my-5 text-center">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-12">
                <img src="{{ asset('images/company.jpg') }}" class="rounded img-fluid" alt="Produk 1"
        ...
        <div class="container my-5 py-5 text-center ">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-sm-6 col-lg-3">
                    ...
                    <a class="btn btn-primary w-100 rounded-top-0 rounded-bottom">Lihat Selengkapnya</a>
                </div>
    ...
    <section class="cta-section container my-5 text-center">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-4 col-12">
                <a href="#" class="btn btn-outline-primary"><i class="fab fa-whatsapp"></i> Hubungi Kami</a>
            </div>
        </div>
    </section>
